...
export class ContactController {
  ...
  public async getMyContacts(
    @Param('userId') userId: string,
    @Res() res: Response,
  ): Promise<any> {
    const acceptedContacts = await this.contactService.getMyContacts(
      Number(userId),
    );
  ...
  public async getInvitationsContact(
    @Param('userId') userId: string,
    @Res() res: Response,
  ): Promise<any> {
    const pendingContacts = await this.contactService.getInvitationsContact(
      Number(userId),
    );
  ...
  public async getReceivedInvitations(
    @Param('userId') userId: string,
    @Res() res: Response,
  ): Promise<any> {
    const invitations = await this.contactService.getReceivedInvitations(
      Number(userId),
    );
