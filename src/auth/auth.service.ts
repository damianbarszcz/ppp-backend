...
export class AuthService{
    ...
    async validateUser(email: string, password: string): Promise<User | null> {
        ...
        if (!user) {
            throw new UnauthorizedException('Nie znaleźliśmy konta pasującego do podanego adresu e-mail i hasła. Sprawdź swój adres e-mail i hasło i spróbuj ponownie.');
        }
