import {
    Body,
    Controller, Delete, Get, HttpStatus, Param, Post, Res,
} from '@nestjs/common';
...
export class FollowerController {
    ...
    async getFollowers(
        ...
        const followers = await this.followerService.getMentorFollowers(Number(mentorId));
    ...
    async checkIfFollowing(
        ...
        const isFollowing = await this.followerService.isFollowing(userId, mentorId);
